...
import type { AccessTokenResponse, CredentialOfferRequestWithBaseUrl, EndpointMetadataResult, JWTSignerCallback, OpenId4VCIVersion } from '@sphereon/oid4vci-common';
...
interface OpenId4VcTokenRequestBaseOptions {
    ...
    dPopKeyJwk?: Jwk;
    getCreateJwtCallback?: (agentContext: AgentContext) => CreateJwtCallback<DPoPJwtIssuerWithContext | JwtIssuerWithContext>;
}
