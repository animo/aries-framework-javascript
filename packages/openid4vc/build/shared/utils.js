...
async function openIdTokenIssuerToJwtIssuer(agentContext, openId4VcTokenIssuer) {
    ...
    if (openId4VcTokenIssuer.method === 'did') {
        ...
        if (!((_b = leafCertificate.sanUriNames) === null || _b === void 0 ? void 0 : _b.includes(openId4VcTokenIssuer.issuer)) &&
            !((_c = leafCertificate.sanDnsNames) === null || _c === void 0 ? void 0 : _c.includes((0, core_1.getDomainFromUrl)(openId4VcTokenIssuer.issuer)))) {
