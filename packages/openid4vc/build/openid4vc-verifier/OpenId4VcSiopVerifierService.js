...
let OpenId4VcSiopVerifierService = class OpenId4VcSiopVerifierService {
    ...
    async getRelyingParty(agentContext, verifierId, { idToken, presentationDefinition, clientId, clientIdScheme, authorizationResponseUrl, responseMode, }) {
        ...
        builder
            ...
            .withClientMetadata(Object.assign(Object.assign({}, jarmClientMetadata), { 
            ...
            client_id: clientId, passBy: did_auth_siop_1.PassBy.VALUE, response_types_supported: [did_auth_siop_1.ResponseType.VP_TOKEN], subject_syntax_types_supported: supportedDidMethods.map((m) => `did:${m}`), vp_formats_supported: {
                mso_mdoc: {
                    alg: supportedAlgs,
                },
                jwt_vc: {
