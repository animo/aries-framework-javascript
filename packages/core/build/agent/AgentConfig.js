...
class AgentConfig {
    ...
    get allowInsecureHttpUrls() {
        var _a;
        return (_a = this.initConfig.allowInsecureHttpUrls) !== null && _a !== void 0 ? _a : false;
    }
    /**
    ...
    get processDidCommMessagesConcurrently() {
        var _a;
        return (_a = this.initConfig.processDidCommMessagesConcurrently) !== null && _a !== void 0 ? _a : false;
    }
    extend(config) {
