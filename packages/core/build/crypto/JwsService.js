...
let JwsService = class JwsService {
    ...
    async jwkFromJws(agentContext, options) {
        ...
        if (protectedHeader.x5c) {
            ...
            const trustedCertificates = [...(trustedCertificatesFromConfig !== null && trustedCertificatesFromConfig !== void 0 ? trustedCertificatesFromConfig : []), ...(trustedCertificatesFromOptions !== null && trustedCertificatesFromOptions !== void 0 ? trustedCertificatesFromOptions : [])];
            ...
            await X509Service_1.X509Service.validateCertificateChain(agentContext, {
                ...
                trustedCertificates: trustedCertificates, // Already validated that it has at least one certificate
            });
