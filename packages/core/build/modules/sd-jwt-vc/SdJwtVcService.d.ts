...
export declare class SdJwtVcService {
    ...
    verify<Header extends SdJwtVcHeader = SdJwtVcHeader, Payload extends SdJwtVcPayload = SdJwtVcPayload>(agentContext: AgentContext, { compactSdJwtVc, keyBinding, requiredClaimKeys, verifyHs256Callback }: SdJwtVcVerifyOptions): Promise<{
        isValid: true;
