        ...
        try {
            ...
            try {
                ...
                signatureResult = await this.jwsService.verifyJws(agentContext, {
                    ...
                    trustedCertificates: (_a = options.trustedCertificates) !== null && _a !== void 0 ? _a : (await (getTrustedCertificatesForVerification === null || getTrustedCertificatesForVerification === void 0 ? void 0 : getTrustedCertificatesForVerification(agentContext, options.verificationContext))),
                });
                if (!signatureResult.isValid) {
