    ...
    async verifyPresentation(agentContext, options) {
        ...
        try {
            ...
            if (certificateChain && !trustedCertificates) {
                const getTrustedCertificatesForVerification = agentContext.dependencyManager.resolve(x509_1.X509ModuleConfig).getTrustedCertificatesForVerification;
                trustedCertificates = await (getTrustedCertificatesForVerification === null || getTrustedCertificatesForVerification === void 0 ? void 0 : getTrustedCertificatesForVerification(agentContext, {
                    certificateChain,
                    verification: {
                        type: 'credential',
                        credential: presentation,
