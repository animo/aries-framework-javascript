...
class MdocDeviceResponse {
    ...
    static fromBase64Url(base64Url) {
        const parsed = (0, mdoc_client_1.parseDeviceResponse)(utils_1.TypedArrayEncoder.fromBase64(base64Url));
        if (parsed.status !== mdoc_client_1.MDocStatus.OK) {
        ...
        const documents = parsed.documents.map((doc) => {
            ...
            const issuerSigned = (0, mdoc_client_1.cborEncode)(prepared.get('issuerSigned'));
            const deviceSigned = (0, mdoc_client_1.cborEncode)(prepared.get('deviceSigned'));
    ...
    static limitDisclosureToInputDescriptor(options) {
        ...
        const _mdoc = (0, mdoc_client_1.parseIssuerSigned)(utils_1.TypedArrayEncoder.fromBase64(mdoc.base64Url), mdoc.docType);
        const disclosure = (0, mdoc_client_1.limitDisclosureToInputDescriptor)(_mdoc, inputDescriptor);
    ...
    static async createOpenId4VpDeviceResponse(agentContext, options) {
        ...
        const issuerSignedDocuments = options.mdocs.map((mdoc) => (0, mdoc_client_1.parseIssuerSigned)(utils_1.TypedArrayEncoder.fromBase64(mdoc.base64Url), mdoc.docType));
        const mdoc = new mdoc_client_1.MDoc(issuerSignedDocuments);
        ...
        const publicDeviceJwk = mdoc_client_1.COSEKey.import(deviceKeyInfo.deviceKey).toJWK();
        const deviceResponseBuilder = await mdoc_client_1.DeviceResponse.from(mdoc)
    ...
    async verify(agentContext, options) {
        var _b, _c;
        const verifier = new mdoc_client_1.Verifier();
        ...
        const trustedCertificates = (_c = (_b = options.trustedCertificates) !== null && _b !== void 0 ? _b : (await (getTrustedCertificatesForVerification === null || getTrustedCertificatesForVerification === void 0 ? void 0 : getTrustedCertificatesForVerification(agentContext, options.verificationContext)))) !== null && _c !== void 0 ? _c : x509ModuleConfig === null || x509ModuleConfig === void 0 ? void 0 : x509ModuleConfig.trustedCertificates;
        ...
        const result = await verifier.verifyDeviceResponse({
            ...
            encodedSessionTranscript: mdoc_client_1.DeviceResponse.calculateSessionTranscriptForOID4VP(options.sessionTranscriptOptions),
        ...
        if (result.status !== mdoc_client_1.MDocStatus.OK) {
